...
## 🆕 Debian 13 limpio — Instalación desde cero

Si el servidor **no tiene PHP ni los módulos configurados**, usa primero:
...
Esto instala y configura **todo** automáticamente antes del despliegue.
